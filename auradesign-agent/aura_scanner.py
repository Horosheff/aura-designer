...
# Настройка кодировки вывода для стабильной печати эмодзи в Windows консоли
...
def scrape_site_style(url):
    ...
    try:
        ...
        print(f"⚠️ Ошибка при запросе к сайту: {e}. Будет использован базовый алгоритм.", file=sys.stderr)
...
def main():
    ...
    try:
        with open(args.output, "w", encoding="utf-8") as f:
            with open("C:\\Users\\mrrut\\Desktop\\disMD\\research\\design-md\\README.md", "r", encoding="utf-8") as r:
                pass # Проверяем доступ к диску
